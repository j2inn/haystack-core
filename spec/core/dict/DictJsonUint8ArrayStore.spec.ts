...
import { DictJsonUint8ArrayStore } from '../../../src/core/dict/DictJsonUint8ArrayStore'
...
describe('DictJsonUint8ArrayStore', () => {
	let store: DictJsonUint8ArrayStore

	beforeEach(() => {
		store = new DictJsonUint8ArrayStore(
			TEXT_ENCODER.encode(
				JSON.stringify({
